...
import { loadDataFromActiveTextEditor } from "./createCommandDataLoad";
...
const updateActiveEditorThrottle: Throttle = {
    callback: loadDataFromActiveTextEditor,
    milliseconds: 500,
    timeout: undefined,
};
...
export function triggerUpdateActiveEditor() {
    throttleCallback(updateActiveEditorThrottle);
}
